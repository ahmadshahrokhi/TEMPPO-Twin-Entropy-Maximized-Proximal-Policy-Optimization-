# -*- coding: utf-8 -*-
"""PPO two critics and Twin loss.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1ilz0h5cD8VxfFI409s4Bk7HGeA0PuHSM
"""
...
env_name = "Google Research Football"
...
eps_clip = 0.2              # clip parameter for PPO it was 0.2
gamma = 0.99                # discount factor
tesla = 0.0003

lr_actor = 0.0003       # learning rate for actor network it was 0.0003
lr_critic = 0.001       # learning rate for critic network it was 0.001
...
# print(next(os.walk(log_dir))[2])
current_num_files = log_dir + 'PPO_Google Research Football_log_0.csv'
